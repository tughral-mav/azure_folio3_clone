...
export function AwardsBand({ autoScroll = false, title }: { autoScroll?: boolean; title?: string } = {}) {
    ...
    <section className="bg-[linear-gradient(120deg,#143CD5_0%,#1742E7_60%,#2F69F2_100%)] py-12">
      <div className="container-x flex flex-col gap-6 lg:flex-row lg:items-center">
        <div className="shrink-0">
          {title ? (
            <h2 className="max-w-[10rem] text-xl font-bold leading-tight text-white">{title}</h2>
          ) : (
            <>
