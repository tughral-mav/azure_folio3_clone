...
export type AgentExtras = { heroStats?: { to: number; suffix?: string; label: string }[]; video?: { youtube: string; poster: string }; aiAdvantageIcons?: string[]; whatYouGet?: { heading: string; tabLabels: string[] } };
