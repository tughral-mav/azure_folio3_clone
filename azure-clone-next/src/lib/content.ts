...
export function getMarketingSlugs(): { slug: string[] }[] {
  ...
  const RESERVED = new Set(['home', 'contact_us', 'thank_you', 'blog', 'azure_for_retail', 'azure_cloud_service', 'azure_managed_services', 'azure_data_analytics', 'end_to_end_bi_solution', 'microsoft_fabric_services', '2_microsoft_fabric_services', 'microsoft_power_platform_services', 'microsoft_power_platform', 'ai_scenario_library', 'petrochemical_producer_edms_compliance_agent']);
  return readdirSync(KIT)
